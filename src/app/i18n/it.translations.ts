...
export const IT_TRANSLATIONS = {
    ...
    projects: {
        uxability: {
            ...
            description: 'Uxability è un\'applicazione web sviluppata in Angular che permette di analizzare l\'accessibilità e le performance di qualsiasi sito web semplicemente inserendo l\'URL desiderato.',
            overview: 'L\'applicazione genera report dettagliati che evidenziano errori, criticità e suggerimenti pratici per il miglioramento, offrendo anche una heatmap interattiva che visualizza graficamente le aree problematiche del sito. Un sistema di intelligenza artificiale integrato fornisce spiegazioni approfondite e chiare sugli errori riscontrati, rendendo le informazioni accessibili anche a chi non ha competenze tecniche.',
            ...
            feature2Title: 'Heatmap Interattiva',
            feature2Desc: 'Visualizzazione grafica delle aree problematiche del sito, permettendo di individuare rapidamente le zone che necessitano di intervento.',
            ...
            feature4Desc: 'Sistema di intelligenza artificiale che spiega gli errori in linguaggio semplice e suggerisce soluzioni concrete per la risoluzione.',
            ...
            ctaText: 'Cosa aspetti? Contattami per saperne di più!',
            howItWorksTitle: 'Come Funziona',
            step1: 'Inserisci l\'URL del sito web da analizzare',
            step2: 'Uxability esegue una scansione completa del sito',
            step3: 'Visualizza il report dettagliato con heatmap interattiva',
            step4: 'L\'AI spiega gli errori e suggerisce le correzioni'
        },
        webExtension: {
            name: 'Estensione Web',
    ...
    pacman: {
        ...
        pressStartRestart: 'PREMI START PER RICOMINCIARE',
        exit: 'ESCI',
        start: 'INIZIA'
    },
